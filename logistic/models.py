...
class StockProduct(models.Model):
    ...
    def __str__(self):
        return f'Продукт {self.product} c количеством {self.quantity} единиц по цене {self.price} тенге'

    class Meta:
        constraints = [models.UniqueConstraint(fields=['stock', 'product'], name='unique constraint')]
